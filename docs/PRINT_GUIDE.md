...
| display_hood_l | 1 | **back plane down, visor up** (144 mm — near the bed edge) | 2 | **touching build plate** — front lip | ASA | 3 / 25% |
...
| baseline_ant_plate | 2 | disc + tongue down, socket up | 5 | no | ASA | 3 / 30% |
