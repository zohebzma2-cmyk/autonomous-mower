...
| 5 | Slamtec RPLIDAR A1M8 | **dims-only** (CORRECTED 2026-06-26) | — | (TraceParts STEP/STL = login) | Slamtec, datasheet free | **Base is a TEARDROP, not round** — footprint **96.74 L × 70.28 W**; rotating cap ⌀**70.04**; bottom boss ⌀**32**; height **51**; **4× ⌀3.4 holes** (NOT 3) in a trapezoid (top pair 56 apart, bottom pair 40 apart, 70 between rows); cable exits at pointed/motor tip; **170 g**. "96.8" some sources quote = the LENGTH; "98.5" = distributor packaging rounding (do NOT design to it). Full breakdown in `cart/research/cad-precision-sensors-gravely.md` | Datasheet Fig 5-2: https://bucket.download.slamtec.com/.../LD108_SLAMTEC_rplidar_datasheet_A1M8_v2.2_en.pdf (host blocks auto-fetch; mirror https://www.farnell.com/datasheets/3176118.pdf) · Free STEP/STL (login): https://www.traceparts.com/en/product/shanghai-slamtec-co-ltd-laser-radar-rplidar-a1m8-kit?Product=90-28042022-033875 |
...
| 8 | u-blox ANN-MB-00 multiband antenna | **dims-only (datasheet-exact)** | — | — | u-blox datasheet UBX-18049862 R05, Fig. 1 | **82.0 × 60.0 × 22.5 mm**; 2× Ø4.5 ear holes on a **68.0 mm** pitch (M4), ears 6.0 thick; ARP at body centre; phase centre spec'd on a Ø120 metal ground plane. Modelled as `ann_mb_body()` / `ann_mb_plate()` in `utils.scad` |
