...
> indicator; pot terminals → 3.5 mm pitch; **HS1 Fischer SK 104 50,8 STC** heatsink (9 K/W) for Q1 +
> a **TO-220 insulating kit** (HS1 is grounded); **F0 = 20 A** (the ATO holder is 22.5 A continuous).
