...
[![Tests](https://img.shields.io/badge/tests-66%2F66-3fb950.svg)](software/tests)
...
![Orbit of the full assembly — every retrofit subsystem placed on the Gravely ZT X 52](cad/renders/hero-orbit.gif)
*Parametric CAD, spec-matched to the full published envelope (1968 × 1610 × 1039 mm · deck 1321 mm · tyres 508/279 mm) — [still renders](gallery.html) · [carrier PCB](hardware/pcb/)*
...
>
> 🕹️ **Already RC-controlled (tracked / slope mower)?** [`docs/ADAPT-RC-MOWER.md`](docs/ADAPT-RC-MOWER.md). The Pixhawk drops in front of the stock drive controller, so you skip the actuators and ESP32.
>
...
> **Building:** [`docs/MEASURE.md`](docs/MEASURE.md) (the 10-minute caliper session — do this first) · [`docs/PRINT-QUEUE.md`](docs/PRINT-QUEUE.md) (40 parts, grams + hours) · [`docs/TOOLS.md`](docs/TOOLS.md) · [`docs/SUBSTITUTIONS.md`](docs/SUBSTITUTIONS.md) · [`docs/CHANGELOG.md`](docs/CHANGELOG.md).
>
...
│   └── wiring-diagram.svg
├── cad/                     ← parametric OpenSCAD — 40 print-ready parts
...
│   ├── tests/               ← 66 stdlib tests (safety, geofence, attachments, turns, coverage, keep-outs, vision, mission encoding)
...
python3 software/tests/test_backend.py       # 66/66
